...
## The game
Two friends, Bob and Tom are at a pier. They go to a restaurant, Bob orders seagull meat, he takes a bite and then he kills himself.  
...
We reduced the problem to a NLI task. We want to use a BERT-like model fine-tuned on NLI datasets. Then, we want to deploy the model 
and use It as an API. This way, we want to be able to play It as a mobile app.  
...
Then, we trained an auxiliary model based on [xtremedistil-l6-h256](https://huggingface.co/microsoft/xtremedistil-l6-h256-uncased).  
